...
import 'ixmlprocessinginstruction.dart';
...
class XmlProcessingInstruction extends IInspectable
  ...
  @override
  String get target => _iXmlProcessingInstruction.target;

  @override
  String get data => _iXmlProcessingInstruction.data;

  @override
  set data(String value) => _iXmlProcessingInstruction.data = value;
