...
class IRandomAccessStream extends IInspectable
    ...
    final hr = ptr.ref.vtable
            ...
            .cast<
                Pointer<
                    NativeFunction<
                        HRESULT Function(
                            LPVTBL, Uint64 position, Pointer<COMObject>)>>>()
            .value
            .asFunction<
                int Function(LPVTBL, int position, Pointer<COMObject>)>()(
  ...
  void seek(int position) {
    final hr = ptr.ref.vtable
        ...
        .cast<
            Pointer<
                NativeFunction<HRESULT Function(LPVTBL, Uint64 position)>>>()
        .value
        .asFunction<
            int Function(LPVTBL, int position)>()(ptr.ref.lpVtbl, position);
