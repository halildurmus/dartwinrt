...
class IStorageLibraryChangeTracker2 extends IInspectable {
  IStorageLibraryChangeTracker2.fromPtr(super.ptr)
      : _vtable = ptr.ref.vtable.cast<_IStorageLibraryChangeTracker2Vtbl>().ref;

  final _IStorageLibraryChangeTracker2Vtbl _vtable;
  ...
  void enableWithOptions(StorageLibraryChangeTrackerOptions? options) {
    final hr = _vtable.EnableWithOptions.asFunction<
  ...
  void disable() {
    final hr = _vtable.Disable.asFunction<int Function(VTablePointer lpVtbl)>()(
        lpVtbl);
...
final class _IStorageLibraryChangeTracker2Vtbl extends Struct {
