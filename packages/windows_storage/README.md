...
[![pub package](https://img.shields.io/pub/v/windows_storage.svg)](https://pub.dev/packages/windows_storage)
[![package publisher](https://img.shields.io/pub/publisher/windows_storage.svg)](https://pub.dev/publishers/win32.pub)
...
[example/](/packages/windows_storage/example) subdirectory, which demonstrate
calling various Windows Runtime APIs from the `Windows.Storage` namespace.
