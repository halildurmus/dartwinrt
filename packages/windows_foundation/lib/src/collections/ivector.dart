...
abstract class IVector<T> extends IInspectable implements IIterable<T> {
  ...
  factory IVector.fromRawPointer(
    ...
    if (isSubtypeOfInspectable<T>()) {
      ...
      return _IVectorIInspectable.fromRawPointer(ptr,
  ...
  void removeAt(int index) {
    final hr = ptr.ref.vtable
        .elementAt(12)
        .cast<Pointer<NativeFunction<HRESULT Function(LPVTBL, Uint32)>>>()
        .value
        .asFunction<int Function(LPVTBL, int)>()(ptr.ref.lpVtbl, index);
