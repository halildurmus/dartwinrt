...
class WinRTDateTimeMethodProjection extends WinRTMethodProjection {
  WinRTDateTimeMethodProjection(WinRTMethodProjection projection)
...
class WinRTDateTimeGetterProjection extends WinRTGetPropertyProjection {
  WinRTDateTimeGetterProjection(WinRTGetPropertyProjection projection)
      : super(projection.method, projection.vtableOffset);
...
class WinRTDateTimeSetterProjection extends WinRTSetPropertyProjection {
  WinRTDateTimeSetterProjection(WinRTSetPropertyProjection projection)
      : super(projection.method, projection.vtableOffset);
...
class WinRTDateTimeParameterProjection extends WinRTParameterProjection {
  WinRTDateTimeParameterProjection(WinRTParameterProjection projection)
