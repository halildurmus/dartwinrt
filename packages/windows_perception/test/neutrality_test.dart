...
// 1. Make sure that the act of including windows_perception a dependency does
...
void main() {
  test('Dormant package does not cause failures on other platforms', () {
    final spatialLocatability = SpatialLocatability.unavailable;
    expect(spatialLocatability, SpatialLocatability.unavailable);
  });
}
