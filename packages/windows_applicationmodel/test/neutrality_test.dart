...
// 1. Make sure that the act of including windows_applicationmodel a dependency
...
void main() {
  test('Dormant package does not cause failures on other platforms', () {
    final startupTaskState = StartupTaskState.disabled;
    expect(startupTaskState, equals(StartupTaskState.disabled));
  });
}
