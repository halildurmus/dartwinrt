...
class ITensorInt16BitStatics2 extends IInspectable {
  ITensorInt16BitStatics2.fromPtr(super.ptr)
      : _vtable = ptr.ref.vtable.cast<_ITensorInt16BitStatics2Vtbl>().ref;

  final _ITensorInt16BitStatics2Vtbl _vtable;
...
final class _ITensorInt16BitStatics2Vtbl extends Struct {
