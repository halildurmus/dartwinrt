...
class ITensorUInt8BitStatics extends IInspectable {
  ITensorUInt8BitStatics.fromPtr(super.ptr)
      : _vtable = ptr.ref.vtable.cast<_ITensorUInt8BitStaticsVtbl>().ref;

  final _ITensorUInt8BitStaticsVtbl _vtable;
...
final class _ITensorUInt8BitStaticsVtbl extends Struct {
